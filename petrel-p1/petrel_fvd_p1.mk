...
PRODUCT_COPY_FILES += \
    device/softwinner/petrel-p1/fstab.sun50iw6p1:root/fstab.sun50iw6p1 \
    device/softwinner/petrel-p1/init.sun50iw6p1.rc:root/init.sun50iw6p1.rc

# Copy Camera cfg files
PRODUCT_COPY_FILES += \
	device/softwinner/petrel-p1/configs/camera.cfg:system/etc/camera.cfg \
	device/softwinner/petrel-p1/configs/cameralist.cfg:system/etc/cameralist.cfg \
	device/softwinner/petrel-p1/configs/media_profiles.xml:system/etc/media_profiles.xml
...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/tv_core_hardware.xml:system/etc/permissions/tv_core_hardware.xml
...
$(call inherit-product, device/softwinner/petrel-p1/device.mk)
$(call inherit-product-if-exists, device/softwinner/common/rtkbt/rtkbt.mk)

PRODUCT_PACKAGE_OVERLAYS := device/softwinner/petrel-p1/overlay \
...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    persist.sys.hdmi_cec_timeout=0 \
