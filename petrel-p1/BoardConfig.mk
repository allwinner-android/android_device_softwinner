...
BOARD_KERNEL_CMDLINE := selinux=1 androidboot.selinux=permissive cma=64M
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/softwinner/petrel-p1/bluetooth
