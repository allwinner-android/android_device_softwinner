...
PRODUCT_COPY_FILES += \
    ...
    device/softwinner/petrel-p1/ueventd.sun50iw6p1.rc:root/ueventd.sun50iw6p1.rc \
    device/softwinner/petrel-p1/recovery.fstab:recovery.fstab \
    device/softwinner/petrel-p1/modules/modules/fivm.ko:root/fivm.ko \
    device/softwinner/petrel-p1/modules/modules/nand.ko:root/nand.ko \
    device/softwinner/petrel-p1/modules/modules/sunxi-ir-rx.ko:root/sunxi-ir-rx.ko
...
PRODUCT_COPY_FILES += \
    ...
    device/softwinner/petrel-p1/configs/sunxi-ir-uinput.kl:system/usr/keylayout/sunxi-ir-uinput.kl
