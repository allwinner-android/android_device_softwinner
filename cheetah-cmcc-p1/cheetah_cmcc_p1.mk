...
PRODUCT_COPY_FILES += \
	device/softwinner/cheetah-cmcc-p1/configs/camera.cfg:system/etc/camera.cfg \
	device/softwinner/cheetah-cmcc-p1/configs/cameralist.cfg:system/etc/cameralist.cfg \
	device/softwinner/cheetah-cmcc-p1/configs/media_profiles.xml:system/etc/media_profiles.xml
...
$(call inherit-product, device/softwinner/cheetah-common/cheetah-common.mk)
$(call inherit-product-if-exists, device/softwinner/cheetah-cmcc-p1/modules/modules.mk)
$(call inherit-product, device/softwinner/cheetah-cmcc-p1/device.mk)
$(call inherit-product-if-exists, device/softwinner/common/rtkbt/rtkbt.mk)
$(call inherit-product-if-exists, vendor/operator/cmcc/cmcc-cntv-common.mk)

PRODUCT_PACKAGE_OVERLAYS := device/softwinner/cheetah-cmcc-p1/overlay \
...
PRODUCT_NAME := cheetah_cmcc_p1
PRODUCT_DEVICE := cheetah-cmcc-p1
PRODUCT_MODEL := molly
