...
PRODUCT_COPY_FILES += \
	...
	device/softwinner/cheetah-common/media_codecs.xml:system/etc/media_codecs.xml \
	device/softwinner/cheetah-common/media_codecs_performance.xml:system/etc/media_codecs_performance.xml \
...
PRODUCT_COPY_FILES += \
	device/softwinner/cheetah-common/init.sun50iw2p1.usb.rc:root/init.sun50iw2p1.usb.rc

# egl
PRODUCT_COPY_FILES += \
	device/softwinner/cheetah-common/egl/egl.cfg:system/lib/egl/egl.cfg \
	device/softwinner/cheetah-common/egl/lib/gralloc.sunxi.so:system/lib/hw/gralloc.sun50iw2p1.so \
	device/softwinner/cheetah-common/egl/lib/libGLES_mali.so:system/lib/egl/libGLES_mali.so
