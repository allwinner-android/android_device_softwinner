...
PRODUCT_COPY_FILES += \
	...
	device/softwinner/petrel-common/media_codecs.xml:system/etc/media_codecs.xml \
	device/softwinner/petrel-common/media_codecs_performance.xml:system/etc/media_codecs_performance.xml \
...
PRODUCT_COPY_FILES += \
	device/softwinner/petrel-common/init.sun50iw6p1.usb.rc:root/init.sun50iw6p1.usb.rc

# egl
PRODUCT_COPY_FILES += \
	device/softwinner/petrel-common/egl/egl.cfg:system/lib/egl/egl.cfg \
	device/softwinner/petrel-common/egl/lib/gralloc.sunxi.so:system/lib/hw/gralloc.sun50iw6p1.so \
	device/softwinner/petrel-common/egl/lib/libGLES_mali.so:system/lib/egl/libGLES_mali.so
...
PRODUCT_PROPERTY_OVERRIDES += \
    ro.product.firmware=oversea-r1.0-release
