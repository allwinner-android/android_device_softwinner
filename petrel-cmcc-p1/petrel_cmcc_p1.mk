...
PRODUCT_COPY_FILES += \
	device/softwinner/petrel-cmcc-p1/configs/camera.cfg:system/etc/camera.cfg \
	device/softwinner/petrel-cmcc-p1/configs/cameralist.cfg:system/etc/cameralist.cfg \
	device/softwinner/petrel-cmcc-p1/configs/media_profiles.xml:system/etc/media_profiles.xml
...
$(call inherit-product-if-exists, device/softwinner/petrel-cmcc-p1/modules/modules.mk)
$(call inherit-product, device/softwinner/petrel-cmcc-p1/device.mk)
...
PRODUCT_PACKAGE_OVERLAYS := device/softwinner/petrel-cmcc-p1/overlay \
...
PRODUCT_NAME := petrel_cmcc_p1
PRODUCT_DEVICE := petrel-cmcc-p1
PRODUCT_MODEL := molly
