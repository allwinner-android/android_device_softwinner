...
PRODUCT_COPY_FILES += \
	device/softwinner/cheetah-p1/configs/camera.cfg:system/etc/camera.cfg \
	device/softwinner/cheetah-p1/configs/cameralist.cfg:system/etc/cameralist.cfg \
	device/softwinner/cheetah-p1/configs/media_profiles.xml:system/etc/media_profiles.xml
...
$(call inherit-product-if-exists, device/softwinner/cheetah-p1/modules/modules.mk)
$(call inherit-product, device/softwinner/cheetah-p1/device.mk)
$(call inherit-product-if-exists, device/softwinner/common/rtkbt/rtkbt.mk)

PRODUCT_PACKAGE_OVERLAYS := device/softwinner/cheetah-p1/overlay \
...
PRODUCT_NAME := cheetah_fvd_p1
PRODUCT_DEVICE := cheetah-p1
PRODUCT_MODEL := molly
